...
echo "[1/6] Installing system packages: $(date)"
apt-get update -qq
apt-get install -y -qq git curl build-essential


# ── 2. Install uv ─────────────────────────────────────────────────────────────
echo "[2/6] Installing uv: $(date)"
export HOME="$WORKDIR"
...
echo "[5/6] Installing Python dependencies: $(date)"
cd "$STAGE2_DIR"
uv sync


# ── 6. Run training ───────────────────────────────────────────────────────────
echo "[6/6] Training $MODEL: $(date)"
