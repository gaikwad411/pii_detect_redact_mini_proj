...
# =========================================================
# 1. CONFIGURATION - HINDI MODEL
# =========================================================

DATA_PATH = r"D:\STUDY\MTech AI\MTech Sem 3\NLP\project PII\pii_project\hindi_pii_dataset.csv"
...
MODEL_SAVE_PATH = "pii_bilstm_hindi.pth"
...
print("=" * 70)
print("Hindi PII Detection Training with 1-Layer BiLSTM")
print("=" * 70)
...
print("\nStarting Hindi PII model training...\n")
...
for epoch in range(EPOCHS):
    ...
    if val_f1 > best_val_f1:
        ...
        print(f"Best Hindi model saved at: {MODEL_SAVE_PATH}")
    ...
    if TARGET_F1_MIN <= val_f1 <= TARGET_F1_MAX:
        print("\nValidation F1 reached target band.")
        print("Stopping Hindi training.")
        break
...
print("\nLoading best Hindi model for final evaluation...\n")
...
print("\nFINAL HINDI TEST SET RESULTS")
print("=" * 70)
print(seqeval_classification_report(test_true, test_pred, digits=4))

test_f1 = print_metrics(
    "Overall Hindi Test Metrics",
    test_true,
    test_pred,
    avg_test_loss
)
